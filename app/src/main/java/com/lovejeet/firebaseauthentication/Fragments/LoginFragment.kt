...
import com.lovejeet.firebaseauthentication.Activity.HomeActivity
import com.lovejeet.firebaseauthentication.Activity.MainActivity
import com.lovejeet.firebaseauthentication.R
import com.lovejeet.firebaseauthentication.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainActivity?.navController?.clearBackStack(R.id.getStartFragment2)
        binding?.tvSignUpNow?.setOnClickListener {
            mainActivity?.navController?.navigate(R.id.signUpFragment)
        }
        binding?.tvForgetPassword?.setOnClickListener {
            mainActivity?.navController?.navigate(R.id.forgetPasswordFragment)
        }
